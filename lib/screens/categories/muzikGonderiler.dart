...
class MuzikGonderileriScreen extends StatefulWidget {
  const MuzikGonderileriScreen({Key? key}) : super(key: key);

  @override
  _MuzikGonderileriScreenState createState() => _MuzikGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _MuzikGonderileriScreenState extends State<MuzikGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Müzik ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Müzik');
