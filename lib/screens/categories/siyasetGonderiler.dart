...
class SiyasetGonderileriScreen extends StatefulWidget {
  const SiyasetGonderileriScreen({Key? key}) : super(key: key);

  @override
  _SiyasetGonderileriScreenState createState() => _SiyasetGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _SiyasetGonderileriScreenState extends State<SiyasetGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Siyaset ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Siyaset');
