...
class MagazinGonderileriScreen extends StatefulWidget {
  const MagazinGonderileriScreen({Key? key}) : super(key: key);

  @override
  _MagazinGonderileriScreenState createState() => _MagazinGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _MagazinGonderileriScreenState extends State<MagazinGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Magazin ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Magazin');
