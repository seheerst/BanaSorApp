...
class IsGonderileriScreen extends StatefulWidget {
  const IsGonderileriScreen({Key? key}) : super(key: key);

  @override
  _IsGonderileriScreenState createState() => _IsGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _IsGonderileriScreenState extends State<IsGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "İş ile ilgili Entry'ler",
