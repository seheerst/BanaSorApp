...
class HayvanGonderileriScreen extends StatefulWidget {
  const HayvanGonderileriScreen({Key? key}) : super(key: key);

  @override
  _HayvanGonderileriScreenState createState() => _HayvanGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _HayvanGonderileriScreenState extends State<HayvanGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Hayvanlar ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Hayvan');
