...
class ModaGonderileriScreen extends StatefulWidget {
  const ModaGonderileriScreen({Key? key}) : super(key: key);

  @override
  _ModaGonderileriScreenState createState() => _ModaGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _ModaGonderileriScreenState extends State<ModaGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Moda ile ilgili Entry'ler",
