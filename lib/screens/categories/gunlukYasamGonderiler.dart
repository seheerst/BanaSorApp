...
class GunlukYasamGonderileriScreen extends StatefulWidget {
  const GunlukYasamGonderileriScreen({Key? key}) : super(key: key);

  @override
  _GunlukYasamGonderileriScreenState createState() => _GunlukYasamGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _GunlukYasamGonderileriScreenState extends State<GunlukYasamGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Günlük Yaşam ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Günlük Hayat');
