...
class FelsefeGonderileriScreen extends StatefulWidget {
  const FelsefeGonderileriScreen({Key? key}) : super(key: key);

  @override
  _FelsefeGonderileriScreenState createState() => _FelsefeGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _FelsefeGonderileriScreenState extends State<FelsefeGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Felsefe ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Felsefe');
