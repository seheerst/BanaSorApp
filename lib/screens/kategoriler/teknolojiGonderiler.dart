...
class TeknolojiGonderileriScreen extends StatefulWidget {
  const TeknolojiGonderileriScreen({Key? key}) : super(key: key);

  @override
  _TeknolojiGonderileriScreenState createState() => _TeknolojiGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _TeknolojiGonderileriScreenState extends State<TeknolojiGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Teknoloji ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Teknoloji');
