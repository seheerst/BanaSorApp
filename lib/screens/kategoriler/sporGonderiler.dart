...
class SporGonderileriScreen extends StatefulWidget {
  const SporGonderileriScreen({Key? key}) : super(key: key);

  @override
  _SporGonderileriScreenState createState() => _SporGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _SporGonderileriScreenState extends State<SporGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Spor ile ilgili Entry'ler",
