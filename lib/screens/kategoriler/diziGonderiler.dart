...
class DiziGonderileriScreen extends StatefulWidget {
  const DiziGonderileriScreen({Key? key}) : super(key: key);

  @override
  _DiziGonderileriScreenState createState() => _DiziGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _DiziGonderileriScreenState extends State<DiziGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Dizi ile ilgili Entry'ler",
