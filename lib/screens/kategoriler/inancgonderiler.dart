...
class InancGonderileriScreen extends StatefulWidget {
  const InancGonderileriScreen({Key? key}) : super(key: key);

  @override
  _InancGonderileriScreenState createState() => _InancGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _InancGonderileriScreenState extends State<InancGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "İnanç ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'İnanç');
