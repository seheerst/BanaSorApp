...
class YemekGonderileriScreen extends StatefulWidget {
  const YemekGonderileriScreen({Key? key}) : super(key: key);

  @override
  _YemekGonderileriScreenState createState() => _YemekGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _YemekGonderileriScreenState extends State<YemekGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Yemek ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Yemek');
