...
class SaglikGonderileriScreen extends StatefulWidget {
  const SaglikGonderileriScreen({Key? key}) : super(key: key);

  @override
  _SaglikGonderileriScreenState createState() => _SaglikGonderileriScreenState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _SaglikGonderileriScreenState extends State<SaglikGonderileriScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Sağlık ile ilgili Entry'ler",
...
class _KategoriGonderisiGetirState extends State<KategoriGonderisiGetir> {
  ...
  Widget build(BuildContext context) {
    Query gonderi = FirebaseFirestore.instance
        ...
        .where('kategori', isEqualTo: 'Sağlık');
